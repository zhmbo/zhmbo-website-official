...
if (isset($_REQUEST["dd"])) {
	...
	//	TEMPLATE
	$template = '<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/><title>' . $subject . '</title></head><body style="margin: 0;"><table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" style="padding: 84px 63px 28px 63px; background-color: #171a19;"><tr><td align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0" style="min-width: 280px; width: 100%; max-width: 494px; margin: 0 auto;"><tr><td align="left" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 21px;"><tr><td align="left" valign="top"><a href="https://zhmbo.cn" target="_blank" style="display: block; text-decoration: none; width: 100px;"><img src="https://zhmbo.cn/campaigns/includes/images/signature.gif" height="28px" style="display: block; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-weight: 400; font-size: 14px; line-height: 28px; color: #fff; white-space: nowrap;" alt="zhmbo signature" title="zhmbosignature"/></a></td><td align="right" valign="top"><a href="https://zhmbo.cn" target="_blank" style="display: block; text-decoration: none; width: 100px;"><img src="https://zhmbo.cn/campaigns/includes/images/identity.png" height="10px" style="display: block; margin: 9px 0; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-weight: 400; font-size: 14px; line-height: 10px; color: #e0a458; white-space: nowrap;" alt="zhmbo" title="zhmbo identity"/></a></td></tr><tr><td align="left" valign="top" style="padding-top: 42px;">';
	...
	//	SEND MAIL
	mail($to, "zhmbo - " . $subject, $template, $headers);
